...
export default function ForgotPasswordPage() {
  ...
  const handleRequestReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!result.success) {
        showError(
          t(result.code || "REQUEST_RESET_ERROR"),
          t(result.code + "_DESCRIPTION" || "REQUEST_RESET_ERROR_DESCRIPTION")
        );
        return;
      }

      showSuccess(
        t("REQUEST_RESET_SUCCESS"),
        t("REQUEST_RESET_SUCCESS_DESCRIPTION")
      );
  ...
  return (
    <>
      <AuthTopBar
        hasBackButton
        backButtonOnClick={() => router.push("/login")}
      />
      <ScrollContainer>
