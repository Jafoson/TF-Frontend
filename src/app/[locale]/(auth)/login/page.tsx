...
export default function LoginPage() {
  ...
  return (
    ...
    <form className={styles.form} onSubmit={handleSubmit}>
      <TextInput type="email" label={t('mail')} placeholder={t('mailPlaceholder')} value={usernameOrEmail} onChange={(value) => {setUsernameOrEmail(typeof value === 'string' ? value : value.target.value); setError(false)}} icon={MailIcon} error={error} />
      <TextInput type="password" label={t('password')} placeholder={t('passwordPlaceholder')} value={password} onChange={(value) => {setPassword(typeof value === 'string' ? value : value.target.value); setError(false)}} icon={LockIcon} error={error} />
