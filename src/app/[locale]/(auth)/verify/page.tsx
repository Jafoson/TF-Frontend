...
export default function ConfirmMailPage() {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!result.success) {
        showError(t(result.code || 'VERIFICATION_ERROR'), t(result.code + '_DESCRIPTION' || 'VERIFICATION_ERROR_DESCRIPTION'))
        return
      }
  ...
  const handleResendEmail = async () => {
    ...
    try {
      ...
      if (!result.success) {
        showError(t(result.code || 'RESEND_ERROR'), t(result.code + '_DESCRIPTION' || 'RESEND_ERROR_DESCRIPTION'))
        setCanResend(true)
