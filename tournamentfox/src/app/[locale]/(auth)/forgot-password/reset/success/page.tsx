...
export default function ConfirmMailSuccessPage() {
  return (
    ...
    <p className={styles.description}>Sie können sich jetzt mit Ihrem neuen Passwort anmelden.</p>
    <div className={styles.formContainer}>
    <Button title="Zum Login" variant='filled' fullWidth className={styles.continueButton}/>
    </div>
    </ScrollContainer>
    </>
  )
